...
<svelte:head>
	...
	<title>The Possible Worlds Tree / FAQ</title>
</svelte:head>

<Container>
	<div class="w-[65ch] lg:w-1/3 pl-0 lg:pl-24 pr-8  left-0 top-8 h-min lg:fixed " slot="left">
	...
	<article class="prose max-w-[60ch] w-full" slot="right">
		...
		<Answer
			...
			includes both humanity going extinct and unrecoverable civilizational collapse. This could
			look like an engineered disease, or artificial intelligence, or something we haven't foreseen.</Answer
		>
		...
		<Answer
			...
			engineer the world to be better for all forms of life. We shouldn't miss our chance to try.
		</Answer>
		...
		<Answer>
			<ul>
				...
				<li>
					<span class="font-bold text-yellow-theme">Yellow</span> branches are ones where humans suffer
					a catastrophe in the next 100 years.
				</li>
				<li>
				...
				<li>
					<span class="underline">'Catastrophes'</span> are defined as events that reduce the human population
					by at least 10%.
				</li>
				<li>
					<span class="underline">'Near-extinction events'</span> are defined as events that reduce the
					human population by at least 95%.
				</li>
			</ul>
		</Answer>
		...
		<Answer>
			...
			can safely predict that humanity will survive: points won't matter if everybody dies. See this
			comment <XLink
		...
		<Answer
			...
			>
			between general forecasters and domain experts. We are happy to include alternative datasets on
			the site from experts, or from famous predictions in our <InternalLink href="/collection"
		...
		>
		<Answer
			>That's awesome! The creator of this site agrees. However, humanity dying out is so bad, that
			it's still worth working on reducing its chances. A 1% chance of billions of people dying is
			too high.</Answer
		>
		...
		<Answer>
			{' '}The tree is based on Mike Bostock's Radial Cluster Tree layout (Copyright 2022
